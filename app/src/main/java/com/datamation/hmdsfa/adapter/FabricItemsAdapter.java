...
public class FabricItemsAdapter extends BaseAdapter {
    private LayoutInflater inflater;
    Context context;
    ArrayList<ItemBundle> list;
    String preText = null;

    public FabricItemsAdapter(Context context, final ArrayList<ItemBundle> list) {
...
//                        } else {
                ...
                keypad.loadValue(Double.parseDouble(""+product.getQuantity()));
