...
import com.datamation.hmdsfa.dialog.CustomKeypadDialogFree;
...
public class ItemBundleAdapter extends ArrayAdapter<ItemBundle> {
    Context context;
    ArrayList<ItemBundle> list;
   // ItemBundle itemDetails;

    public ItemBundleAdapter(Context context, ArrayList<ItemBundle> list) {
   // public ItemBundleAdapter(Context context, ArrayList<ItemBundle> list, ItemBundle itemDetails) {
    ...
    public View getView(final int position, final View convertView, final ViewGroup parent) {
        ...
        code.setText(list.get(position).getDocumentNo());
        name.setText(list.get(position).getDescription());
        alloc.setText(list.get(position).getBarcode());
