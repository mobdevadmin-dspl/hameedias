package com.datamation.hmdsfa.fragment.debtordetails;
...
//        }
    ...
    private static class ViewHolder {
        LinearLayout layout;
        com.datamation.hmdsfa.utils.CustomFont invoiceId;
        com.datamation.hmdsfa.utils.CustomFont invoiceDate;
    ...
    private class OutletOutstandingAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                viewHolder.invoiceId = (com.datamation.hmdsfa.utils.CustomFont) convertView.findViewById(R.id.row_refno);
                viewHolder.invoiceDate = (com.datamation.hmdsfa.utils.CustomFont) convertView.findViewById(R.id.row_txndate);
                viewHolder.invoiceAmt = (com.datamation.hmdsfa.utils.CustomFont) convertView.findViewById(R.id.row_dueAmt);
                viewHolder.invoiceBalance = (com.datamation.hmdsfa.utils.CustomFont) convertView.findViewById(R.id.row_Amt);
                viewHolder.invoiceDays = (com.datamation.hmdsfa.utils.CustomFont) convertView.findViewById(R.id.days);
