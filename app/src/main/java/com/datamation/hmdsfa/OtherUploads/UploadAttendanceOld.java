package com.datamation.hmdsfa.OtherUploads;
...
public class UploadAttendanceOld extends AsyncTask<ArrayList<Attendance>, Integer, ArrayList<Attendance>> {
    ...
    public UploadAttendanceOld(Context context, UploadTaskListener taskListener, ArrayList<Attendance> attList) {
